...
let BundlesService = class BundlesService extends service_base_service_1.ServiceBase {
    ...
    constructor(sequelize) {
        super(bundle_model_1.BundleModel, sequelize);
    ...
    findAssociatedProductsByBundle() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.bundleModelRepository.findAndCountAll({
                distinct: true,
            });
